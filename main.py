...
def typing_test_max_val(max_inputs):
    ...
    while True:
        if cnt_letters == num_letters_to_type:
            ...
            print("Type the letter: " + Fore.YELLOW + random_letter + Style.RESET_ALL)
            ...
            if typed_letter == random_letter:
                ...
                print("You typed the letter " + Fore.GREEN + typed_letter + Style.RESET_ALL)
            elif typed_letter == " ":
                ...
                print("You typed the letter " + Fore.RED + typed_letter + Style.RESET_ALL)
